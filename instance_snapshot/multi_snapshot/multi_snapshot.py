...
qa_tag_value = config['tag_value1']
...
def snapshot_delete (vol_id, del_days):
    ...
    prodAllSnapshots=connection.get_all_snapshots(owner='self',filters={'volume_id':vol_id})
...
create_snap = snapshot_create (qa_vol_id, qa_tag_value)
del_snap = snapshot_delete(qa_vol_id, qa_days_del)
